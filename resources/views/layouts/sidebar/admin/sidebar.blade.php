    ...
    <nav class="nav" id="nav1">
        <div>
            ...
            <div class="nav_list">
                ...
                <a href="/admin" class="nav_link bs-tooltip-right" data-bs-toggle="tooltip" data-placement="right" title="Messages">
                    <i class='material-icons nav_icon'>dashboard</i>
                    <span class="nav_name">Dashboard</span>
                </a>
                <a href="/admin/message" class="nav_link" data-bs-toggle="tooltip" data-placement="right" title="Contacts">
                    <i class='material-icons nav_icon'>mic</i>
                    <span class="nav_name">Message</span>
                </a>
                <a href="/admin/campagne" class="nav_link" data-bs-toggle="tooltip" data-placement="right" title="Campagnes">
                    <i class='material-icons nav_icon'>campaign</i>
                    <span class="nav_name">Campagnes</span>
                </a>
                <a href="/admin/contact" class="nav_link" data-bs-toggle="tooltip" data-placement="right" title="Contacts">
                    <i class='material-icons nav_icon'>groups</i>
                    <span class="nav_name">Contacts</span>
                </a>
                 <a href="/admin/utilisateur" class="nav_link" data-bs-toggle="tooltip" data-placement="right" title="Paramétre">
                ...
                {{-- <a href="/admin" class="nav_link" data-bs-toggle="tooltip" data-placement="right" title="Stats">
                            <i class='material-icons nav_icon'>leaderboard</i>
                            <span class="nav_name">Stats</span>
                </a>  --}}
                <a href="/admin/historique" class="nav_link" data-bs-toggle="tooltip" data-placement="right" title="Historique">
