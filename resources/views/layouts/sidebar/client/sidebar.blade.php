{{-- <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item  active">
            <a class="nav-link" href="/client/utilisateur" >
    ...
    <nav class="nav">
        <div>
            ...
            <div class="nav_list">
                ...
                <a href="#" class="nav_link bs-tooltip-right" data-toggle="tooltip" data-placement="right" title="Messages">
                ...
                <a href="#" class="nav_link" data-toggle="tooltip" data-placement="right" title="Contacts">
                    <i class='material-icons nav_icon'>groups</i>
                    <span class="nav_name">Contacts</span>
                </a>
                 <a href="#" class="nav_link" data-toggle="tooltip" data-placement="right" title="Paramétre">
                ...
                <a href="#" class="nav_link" data-toggle="tooltip" data-placement="right" title="Stats">
                            <i class='material-icons nav_icon'>leaderboard</i>
                            <span class="nav_name">Stats</span>
                </a>
                <a href="#" class="nav_link" data-toggle="tooltip" data-placement="right" title="Historique">
