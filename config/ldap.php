            ...
            */
            ...
            'settings' => [
                ...
                */
                ...
                'hosts' => explode(' ', env('LDAP_HOSTS', '51.83.69.193')),
                ...
                */
                ...
                'base_dn' => env('LDAP_BASE_DN', 'dc=mlouma,dc=com'),
                ...
                */
                ...
                'username' => env('LDAP_USERNAME', 'cn=admin,dc=mlouma,dc=com'),
                'password' => env('LDAP_PASSWORD', '9aeM%k*F7{3H'),
                // 'username' => env('LDAP_USERNAME', 'ou=people,dc=mlouma,dc=com'),
